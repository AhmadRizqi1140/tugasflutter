...
//Default Value
  ...
  //Pakai Default Value
  //guest = 'rizqi'; //bakal tampil warning karena dart tau value nya sudah kita set di bagian ini String guestName = guest ?? 'ahmad';
  String guestName = guest ?? 'ahmad'; // String guestName = guest ??;

  //Pakai Ternary
  //String guestName = guest != null ? guest : 'ahmad';
